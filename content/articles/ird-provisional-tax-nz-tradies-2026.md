...
- Your tax liability for the previous year was **more than NZ$2,500**, OR
- The IRD has issued you a provisional tax assessment
...
1. **Gross income to IRD:** $85,000
2. **Tax rate (top rate for this band):** ~33% (for tradies earning $70k–$180k)
3. **Estimated annual tax:** $85,000 × 0.33 = **$28,050**
4. **Per instalment:** $28,050 ÷ 3 = **$9,350** (approximately)

### Did Your Income Change?

If you expect to earn **significantly more** this year (e.g., you won 10 big jobs), you can request an **adjustment** to your provisional tax. The IRD calls this a "provisional tax change" and you can do it online at [myIR.govt.nz](https://myir.govt.nz).
...
If you haven't got the cash, paying late is tempting — but penalties hurt more. Better options:
- Ask your accountant about **provisional tax installment plans** (the IRD sometimes approves these if you're in genuine hardship)
- Use an accounting software like [Fastcrew](https://fastcrew.nz) to forecast cash flow and set aside money each week
...
The IRD can ask for invoices, receipts, and records for up to **7 years**. If you can't prove your income or deductions, they'll estimate it — and you'll lose. Keep:
- All client invoices (even handwritten quotes if you use them)
...
1. **Check your email/myIR** — Did the IRD send a third instalment notice for 7 May 2026? If yes, pay immediately.
2. **Contact your accountant** — If your income will be significantly different this year, request a provisional tax adjustment.
3. **Set up weekly savings** — If you're unsure of your cash flow, put aside 1/52 of your estimated annual tax each week. For a tradie earning $85k/year, that's ~$180/week.
4. **Download our templates** — Use our free NZ tradie templates at [tradietools.nz/templates/](https://tradietools.nz/templates/) to track income and expenses.

## Keep Your Finances Organized

Managing provisional tax becomes easier when you track income and expenses in real time. Apps like [Fastcrew](https://fastcrew.nz) integrate job costing, invoicing, and tax records in one place — saving hours of admin each month.
