...
draft: false
faqs:
  - q: "How much does a roof replacement cost in NZ?"
    a: "A new roof typically costs $12,000–$25,000 for a small 100 m² house, $18,000–$40,000 for a medium 150 m² home, and $30,000–$60,000+ for a large 200 m²+ house. The exact price depends heavily on the roofing material, roof pitch, access and whether scaffolding is needed."
  - q: "How long does a roof replacement take?"
    a: "Most residential reroofing jobs take 3 to 7 working days. Simple single-storey long-run steel roofs are at the faster end, while complex roofs with multiple valleys, steep pitches or tile removal take longer. Weather delays can extend the timeline."
  - q: "Do I need building consent to replace a roof in NZ?"
    a: "A like-for-like roof replacement using the same material generally doesn't need building consent. Consent is usually required if you change the roofing material, alter the structure, or change the roof pitch. Always use a licensed roofer, and an LBP where consent applies."
  - q: "What's the cheapest roofing material in NZ?"
    a: "Corrugated steel (long-run) is the most affordable roofing material in New Zealand, both to supply and install. It's lightweight, durable, and suits most home styles, which is why it dominates NZ residential roofing."
  - q: "How do I find a reliable roofer in NZ?"
    a: "Get at least three written quotes, check the roofer is experienced and insured, and confirm they'll provide both a product warranty and a workmanship warranty. Ask whether old roof removal and disposal is included, and look at reviews and recent jobs before choosing."
  - q: "Colorsteel vs tiles — which is better in NZ?"
    a: "Colorsteel (long-run steel) is lighter, faster to install, and generally cheaper, with warranties of 30 years or more. Concrete and clay tiles are heavier, can suit certain architectural styles and climates, and last a long time but cost more to install and may need a stronger roof structure."
  - q: "Can I reroof my house myself?"
    a: "Reroofing is dangerous, working-at-height work and is best left to licensed roofers. DIY roofing risks falls, leaks, voided warranties and failed weathertightness. If the job requires building consent, it must be done or supervised by a Licensed Building Practitioner."
  - q: "When should I replace my roof instead of repairing it?"
    a: "Replace the roof if it has widespread rust or corrosion, multiple leaks, failing fixings across large areas, or is simply at the end of its lifespan. Spot repairs make sense for isolated, localised damage, but repeated repairs on an old roof usually cost more than a full replacement over time."
---
...
## NZ's Most Popular Roofing Materials
