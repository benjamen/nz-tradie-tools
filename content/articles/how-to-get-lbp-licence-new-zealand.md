...
draft: false
faq:
  - q: "How long does it take to get an LBP licence in NZ?"
    a: "MBIE targets 40 working days (8 weeks) for most LBP applications once they have a complete application. In practice, qualification pathway applications often take 6–10 weeks. Experience pathway applications can take 3–5 months as assessors review your portfolio."
  - q: "How much does an LBP licence cost in NZ?"
    a: "The LBP application fee is $415. If approved, your first annual licensing fee is $178. After that, renewal is $178/year. Skills maintenance training costs $100–$500 per 2-year cycle depending on what courses you attend."
  - q: "Can I apply for LBP without a qualification?"
    a: "Yes. The Experience Pathway lets you apply based on work history — typically 5+ years of relevant restricted building work. You need references from other LBPs or clients, documentation of completed projects, and may need to pass a trade assessment."
  - q: "What is restricted building work in NZ?"
    a: "Restricted building work (RBW) is building work on residential buildings that affects structure or weathertightness — including foundations, framing, load-bearing walls, roof cladding, exterior cladding, and deck structures over 1.5m. You must be an LBP (or work under one) to carry out or supervise RBW."
  - q: "What happens if my LBP licence lapses?"
    a: "You cannot carry out or supervise restricted building work once your licence lapses. You'll need to reapply, which requires meeting current competency requirements. If your licence has lapsed for more than 12 months, you may need to restart the application process."
---
...
Requirements:
- Typically **5+ years** of relevant restricted building work
- References from other LBPs, architects, engineers, or clients who can verify your work
- Documentation of completed projects (photos, job records, consented plans you supervised)
- A portfolio showing your range of competence across the relevant class
- May include a **trade assessment** (practical or written test)
...
**Step 1 — Choose your licence class(es)**
Decide which LBP class you're applying for. Most applicants start with Carpentry.

**Step 2 — Gather your evidence**

For qualification pathway:
- Certificates and transcripts
- Identity documents
- Two references from industry contacts (LBPs, architects, or clients)

For experience pathway, add:
- Employment history (employer names, dates, types of work)
- Project portfolio with photos, plans, and job descriptions
- Statutory declarations where required
- References from other LBPs or professionals who've seen your work

**Step 3 — Complete the online application**
Apply at [lbp.govt.nz](https://www.lbp.govt.nz). You'll create an account, fill in the application form, and upload supporting documents.

**Step 4 — Pay the fee**
Current application fee: **$415**. Payable by credit card online.

**Step 5 — Wait for assessment**
MBIE targets 40 working days from receipt of a complete application. If they need more information (RFI), the clock pauses — respond promptly. Experience pathway applications routinely take longer due to portfolio assessment.

**Step 6 — Receive your licence**
Once approved, you get your LBP number and card. Your number must appear on:
- All building consent documents you lodge or supervise
- Statutory declarations (Record of Building Work)
- Any correspondence with councils about restricted building work
...
- Industry training courses (20–40 points each)
- Online learning modules on MBIE's LBP site
- Attending industry events (conferences, trade shows)
- Reading and reflecting on published industry guidance
- First aid/site safety courses
...
The MBIE public register at [lbp.govt.nz/public-register](https://www.lbp.govt.nz/public-register) lets anyone check whether a builder is licensed, what class they hold, and whether their licence is current. Homeowners and councils increasingly check this before engaging builders or accepting consent applications.
...
*See also: [LBP Skills Maintenance Guide NZ](/articles/lbp-cpd-compliance-renewal-nz-2026) and [How Much Do Builders Charge in NZ?](/articles/builder-pricing-guide-nz-2026)*
