...
The registrations came alongside broader building system reforms including:
- The Building (Liability) Amendment Bill (currently before Parliament), which introduces proportionate liability for defective work
- New mandatory home warranty insurance requirements for residential builds up to three storeys
- Ongoing consent process digitalisation under MBIE's building system reform programme
...
Private BCAs have the same legal powers as council BCAs for the work they're accredited to process. That means they can:
- Accept and process consent applications
...
Your Licensed Building Practitioner licence obligations are entirely unchanged by the introduction of private BCAs. Regardless of who processes the consent, you still need to:
- Ensure all restricted building work is completed by an LBP with the correct licence class
...
Staying connected with industry updates through your trade association — or using a job management tool like [Fastcrew](https://fastcrew.nz), which surfaces industry news alongside scheduling and quoting — is the easiest way to track these changes without monitoring government websites manually.
