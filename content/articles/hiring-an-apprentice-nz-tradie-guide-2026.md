...
1. Apply through Work and Income (workandincome.govt.nz/employers/apprenticeship-boost)
2. Apply within **20 days** of your apprentice starting — don't miss this window or you'll lose the payments
3. Reconfirm your details **each month** to keep payments flowing
...
**Use job management software to track their progress.** Tools like [Fergus](https://www.fergus.com/) or [Tradify](https://www.tradifyhq.com/) let you assign jobs, track hours, and document what your apprentice has worked on — which also helps with BCITO's competency records. Keeping a paper-based log is painful; good software makes it automatic.
