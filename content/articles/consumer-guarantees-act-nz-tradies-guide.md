...
**For a major failure** — work that can't be fixed, was done so badly a reasonable person wouldn't have agreed to it, or doesn't substantially achieve its intended purpose — the customer can:
- Cancel the contract and get a refund (less an amount for the value already received), or
- Keep the contract and claim compensation for the reduction in value
