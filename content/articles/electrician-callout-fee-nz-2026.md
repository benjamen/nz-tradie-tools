...
draft: false
faqs:
  - q: "Do all electricians charge a callout fee in NZ?"
    a: "Most do, but it varies. Some charge a flat callout fee, some charge the first-hour rate as the callout, and some waive the callout if the job goes ahead. Always ask how the callout works before booking so there are no surprises on the invoice."
  - q: "How much is a sparky in NZ?"
    a: "Expect a callout fee of $80–$160, which often covers the first 30 minutes to an hour, then an hourly rate of $80–$120 after that. After-hours, weekend and public holiday work is charged at 1.5 to 2 times the standard rate."
  - q: "Can I do any electrical work myself in NZ?"
    a: "Homeowners can do a very limited list of minor tasks like replacing a light fitting or repairing a lamp, but most electrical work — including anything involving wiring, switchboards or new circuits — must legally be done by a licensed electrician. DIY electrical work is dangerous and can void your insurance."
  - q: "What is a Certificate of Compliance (COC)?"
    a: "A Certificate of Compliance is a legal document a licensed electrician issues to certify that the electrical work they've done is safe and meets NZ standards. You should always receive a COC for prescribed electrical work — keep it for insurance and any future property sale."
  - q: "How do I know if an electrician is licensed in NZ?"
    a: "All electricians in NZ must be registered and hold a current practising licence with the Electrical Workers Registration Board (EWRB). You can check an electrician's registration on the EWRB public register before hiring them."
  - q: "How can I reduce my electrician costs?"
    a: "Group several jobs into one visit so you only pay one callout, get quotes for larger non-urgent work, do safe basic troubleshooting first (like checking whether a breaker has simply tripped), and ask for a fixed-price quote on known jobs rather than charging by the hour."
---
