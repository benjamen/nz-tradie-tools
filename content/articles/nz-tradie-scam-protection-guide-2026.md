...
In April 2026, a 92-year-old New Zealand woman lost almost everything she had to a scammer impersonating a tradie. The story made national headlines — and it should concern every legitimate tradie in the country. Not just because it's a terrible outcome for a vulnerable person, but because it demonstrates exactly how badly fake operators can damage the reputation of genuine, hardworking tradespeople.

Scams involving fake tradies are on the rise in New Zealand. As winter arrives and homeowners start booking maintenance work — roof checks, insulation upgrades, heat pump servicing, plumbing repairs — the conditions are ripe for opportunistic fraudsters to exploit. This guide covers what's happening, how it affects your business, and practical steps you can take to protect yourself and your customers.
...
If you do restricted building work, your LBP number is publicly searchable on the [MBIE building practitioner register](https://www.building.govt.nz/building-officials/national-multiple-use-approval/lbp/). Include it in your quotes, email signature, and website. Scammers cannot fake a real LBP number tied to a name.

Electricians, plumbers, and gasfitters are similarly licensed through the [Electrical Workers Registration Board](https://www.ewrb.govt.nz) and [Plumbers, Gasfitters and Drainlayers Board](https://www.pgdb.co.nz). Display these credentials prominently.
...
Scammers often ask for full payment upfront. Legitimate tradies generally ask for a modest deposit (10–30% for larger jobs) and invoice on completion or at agreed milestones. If a customer seems nervous about a deposit, explain your payment structure clearly. Transparency builds trust.

For large projects, consider progress billing tied to milestones rather than large upfront sums — this protects both you and the customer.
...
[Fastcrew](https://fastcrew.nz) is a New Zealand-built tradie app that handles job management, invoicing, and customer communication in one place. Using a professional app like Fastcrew means every customer interaction — quote, update, invoice — arrives via a branded, professional interface rather than an informal text or handwritten note. It also creates a digital paper trail that protects you if a dispute arises.
...
This isn't just good ethics — it's good marketing. Customers who feel protected by you become loyal, repeat clients.
...
Download our free NZ tradie templates — including quote templates, contracts, and progress invoice formats — at **tradietools.nz/templates/**
