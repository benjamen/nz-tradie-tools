...
If you use subbies, or if you work as a subcontractor yourself, there's a significant change you need to know about. On **21 February 2026**, the Gateway Test became law in New Zealand. It's the first formal legislative test for determining whether a worker is a contractor or an employee — and it changes how disputes get resolved.

This matters directly to tradies. Misclassifying a worker — even accidentally — can leave a business on the hook for backdated PAYE, KiwiSaver, and ACC. Getting it right upfront is far cheaper than sorting it out later.

---

## Why This Change Happened

Before the Gateway Test, whether someone was a contractor or employee came down to the "common law test" — a loose set of factors developed through court cases over decades. The problem was that this test was unpredictable. Two businesses with almost identical contractor arrangements could get different outcomes depending on which judge heard the case.

Workers in construction, trades, and contracting had been caught out repeatedly — classified as employees by the Employment Relations Authority even when both parties believed the contractor arrangement was genuine.
...
The worker must be able to provide their services to other people or businesses — not just be locked in to one principal.
...
Either:
- The worker can choose when they work and how they do the job, **or**
- The worker can subcontract the work to someone else (i.e. send their own people)
...
So passing the gateway is a safe harbour — fail the gateway and you're back to the uncertain common law analysis.
...
**Common issue in trades:** You've got a "subcontractor" who:
- Works exclusively for you
- You tell them exactly what hours to be on site
- They can't send someone else to do the work
- They'd lose the contract if they turned down a job

That arrangement fails the Gateway Test on at least two of the three criteria. IRD is likely to view it as employment — meaning you should be deducting PAYE, paying employer KiwiSaver contributions, and covering ACC levies.
...
The same test applies from the other side. If you're genuinely contracting — multiple clients, control over your hours, can send a worker in your place — the Gateway Test protects you.
...
Separate from the employee/contractor question, most subcontractors in the building trades receive **schedular payments** — and the payer must deduct withholding tax.
...
This is different from the employment question. A genuine contractor can still be subject to schedular payments. The Gateway Test only determines whether someone is a contractor or employee — the schedular payment rules apply on top of that once contractor status is confirmed.

If you're paying subbies, you need to:
1. Confirm contractor status under the Gateway Test
2. Deduct the correct withholding rate from payments
3. File IR15 schedular payment returns with IRD
...
| Can subcontract/delegate work | ✅ | ❌ |
| Can decline jobs without penalty | ✅ | ❌ |
| Gets paid per job (not hourly/weekly) | ✅ | ❌ |
| Invoices for work | ✅ | ❌ |
| Works exclusively for one business | ❌ | ✅ |
| Directed by the business on how to work | ❌ | ✅ |
| On a regular roster | ❌ | ✅ |
...
Using proper job management software like [Fergus](https://www.fergus.com/) or [Tradify](https://www.tradifyhq.com/) helps here — you can document work scopes, issue purchase orders to subbies, and keep clean records of what was agreed and paid.
