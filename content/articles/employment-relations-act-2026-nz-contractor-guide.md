...
New employment law that passed on 21 February 2026 has significantly changed how contractor agreements work in New Zealand — and if you run a trade business and use subbies, your contracts may already be out of date.
...
For trade business owners, this is both an opportunity and a responsibility. Get it right and you have genuine legal certainty. Get it wrong and you're still exposed — possibly more so than before.

---

## What Changed (and What Stayed the Same)

The gateway test itself — the four-part check used to determine whether someone is a contractor or an employee — remains in place. What has changed is the legal consequence of passing it.
...
1. **Freedom to work for others** — the contractor is not restricted from working for competing businesses or other clients
2. **Flexibility around time or the ability to subcontract** — the contractor controls when they work, or can send someone else in their place
...
Contracts written before February 2026 were drafted against the old legal landscape. Many standard subcontractor agreements — especially the template-style ones common in the construction and electrical trades — do not explicitly address all three of the new statutory elements. They may reference the gateway test in general terms, or simply include a line saying "you are an independent contractor," without spelling out the specific freedoms required.
...
- Not rely on verbal agreements or industry custom — the statutory protections only apply to properly documented written arrangements
...
**2. Update any agreements that fall short.** Have a solicitor or employment law specialist redraft the relevant clauses. This does not need to be expensive — many NZ employment lawyers offer fixed-fee contract reviews starting from around $300–$500 plus GST.
...
Keeping compliant contractor documentation isn't just a legal exercise — it's also a workflow challenge. **[Fastcrew](https://fastcrew.nz)** is an NZ-built app for managing your crew, including subbies, and it allows you to store signed agreements, track who is on site, and manage payment records in one place. Given that the 2026 Act places significant emphasis on the existence of a properly documented written agreement, having a system for storing and retrieving those records quickly is genuinely valuable.

---

## Download Our Free Contractor Agreement Template

Download our free NZ tradie templates — including a subcontractor agreement template updated for the 2026 Employment Relations Amendment Act — at tradietools.nz/templates/

---

## In Summary

The Employment Relations Amendment Act 2026 is a genuine improvement for trade businesses that use subbies — but only if your agreements are updated to reflect the new requirements. If your current contracts predate February 2026 or don't explicitly address the three key elements, you're not getting the protection the new law offers.
