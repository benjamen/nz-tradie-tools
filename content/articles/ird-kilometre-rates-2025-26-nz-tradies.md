...
The 2025–26 income year ended 31 March 2026 — which means your IR3 return is due by **7 July 2026** if you file yourself. If you're a self-employed tradie using the IRD kilometre rate method to claim vehicle expenses, now is the time to add up your logbook kilometres and lock in your deduction.
...
> **Always verify the current rates at [ird.govt.nz](https://www.ird.govt.nz)** before filing. IRD publishes updated rates in their "Kilometre rates for the business use of vehicles" guidance each year.
...
**Use km rates if:**
- Your total business km is relatively low (under ~15,000 km)
- You don't want the admin of tracking every receipt
- Your vehicle is older and low in value (so depreciation is minimal)
...
If IRD queries your vehicle claim, a well-maintained digital mileage log will protect you. Apps like Fastcrew ([fastcrew.nz](https://fastcrew.nz)) can help you track job-related travel alongside your invoicing, making it easy to reconcile km with actual jobs attended.
