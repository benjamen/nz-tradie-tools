...
1. **Separate your bank accounts** from day one
2. **Track rolling turnover** — register for GST before you hit $60k
3. **Keep a vehicle logbook** — it's the single biggest deduction lever
4. **Claim proportional costs** on mixed-use assets
5. **Store receipts digitally** and keep records for 7 years
6. **Calendar your provisional tax** due dates: 28 Aug / 15 Jan / 7 May
7. **Check for all deductions** — underclaimiing is money left on the table
8. **Get a tradie-focused accountant** — their fee pays for itself
