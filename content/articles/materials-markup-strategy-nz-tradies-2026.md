...
**Watch out for:** Clients may ask for invoices to verify your costs. Keep your supplier invoices filed properly — [IRD](https://www.ird.govt.nz/) may also request them during an audit, and your markup must be consistently applied.
...
Example:
- You buy $500 of pipe fittings (exclusive of GST)
- You mark up 30% = $650 ex-GST
- You invoice $650 + $97.50 GST = $747.50 total
...
For a tradie buying a $5,000 table saw or a $12,000 work trailer, this translates to a meaningful tax saving in your 2025/26 return. IRD's guidance on this is available at [ird.govt.nz](https://www.ird.govt.nz/).
...
Apps like [Fastcrew](https://fastcrew.nz) let you track time and materials against each job on-site from your phone, so your job cost data is real-time rather than reconstructed from receipts at month end. When you can see actual vs quoted materials on every job, you'll quickly spot if your markup is too thin.

---

## A Quick Checklist Before You Quote Materials

1. **List materials by line item** — don't lump them into a single "materials" figure
2. **Get real supplier prices** — don't guess, especially on items with price variability
3. **Add wastage** — typically 5–15% depending on trade and material type
4. **Apply your markup consistently** — same rate for all materials on the job
5. **Add a price escalation clause** for jobs over 6 weeks or $10,000 in materials
6. **Check your GST treatment** — are you registered? Are materials GST-exclusive in your calc?
7. **File supplier invoices** — IRD may ask, clients on cost-plus will often ask
