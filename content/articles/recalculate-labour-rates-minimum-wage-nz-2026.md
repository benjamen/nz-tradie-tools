...
When New Zealand's minimum wage went up to $23.95 per hour on 1 April 2026, many tradies updated their payroll systems—but forgot to update their quote templates. This oversight silently erodes profit margins on every job quoted under the old rates.
...
**Example:**
- Old scenario: Employee earning $23.50/hr (before April increase). Your all-in labour cost was $29.38/hr (25% on-costs). You quoted at $60/hr.
- New scenario (post-April): Employee now earning $23.95/hr minimum. Your all-in labour cost is now $29.94/hr. You're still quoting at $60/hr.
...
- **ACC levies:** Approximately 1.5% of gross for typical tradie roles (check [ACC.co.nz](https://www.acc.co.nz) for your exact classification)
...
- Leave (9%): $2.16
- Admin (2.5%): $0.60
- **Total all-in cost: $27.79/hr**

Not $23.95. That 17% buffer is the difference between a competitive quote and a loss-making one.

Check your own figures with our [**Labour Cost Calculator**](/calculators/labour-cost-calculator.html) — it accounts for your specific ACC classification and contribution rates.
...
- All-in labour cost: $27.79/hr
- Overhead rate (40%): $11.12/hr
- Subtotal: $38.91/hr
- Desired profit margin (25%): $9.73/hr
- **Charge-out rate: $48.64/hr**

Our [**Job Costing Calculator**](/calculators/job-costing-guide.html) lets you input your exact overheads and target margin to see your rate in real time.
...
If you quoted at $50/hr, $55/hr, or $60/hr — but your new all-in cost is $27.79/hr with overheads at $38.91/hr — you're either:
1. Underquoting (rate too low), or
2. Operating with margins too thin (rate doesn't cover overheads + profit)
...
**Update it for:**
- Each trade you employ (electricians, carpenters, plumbers may have different overheads)
- Callout vs. fixed-price work (callout rates are usually higher)
- Onsite supervision vs. direct labour
...
- **[Labour Cost Calculator](/calculators/labour-cost-calculator.html)** — Input your wage, ACC classification, and KiwiSaver to calculate all-in cost
- **[Job Costing Guide](/calculators/job-costing-guide.html)** — Plug in overhead rate and profit target to see your exact charge-out rate
- **[Markup vs. Margin Calculator](/calculators/markup-margin.html)** — Avoid the classic 42% markup = 42% margin mistake
...
**Download our free NZ tradie templates at [tradietools.nz/templates/](https://tradietools.nz/templates/)** — including labour rate worksheets and quote templates pre-built for the April 2026 wage increase.
