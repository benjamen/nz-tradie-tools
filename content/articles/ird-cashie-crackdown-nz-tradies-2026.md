...
If you've been doing the odd cash job and thinking IRD won't notice, it's time to reconsider. Inland Revenue has dramatically stepped up enforcement in 2026, with trades — particularly plumbing, building, and electrical work — named as priority targets. Here's what's happening, what it means for your business, and how to make sure you're on the right side of the line.

## What's Changed in 2026

IRD's latest compliance campaign is not business as usual. In the past six months alone, Inland Revenue has opened **3,600 audits** — a 50% increase year-on-year — and those investigations have already uncovered an estimated **$600 million in undeclared taxes** nationwide.
...
The trades singled out are no coincidence. Building, plumbing, and electrical work are high-cash industries where invoicing is sometimes optional and jobs are often priced verbally. IRD knows this — and they have the data to act on it.

## What Counts as a "Cashie"?

A cashie isn't just a job where you accept physical cash. Under the Income Tax Act 2007, **all income is taxable regardless of how it's paid** — cash, bank transfer, crypto, or favour-in-kind.
...
Even if the amounts seem small — a $500 deck fix here, a $300 tap job there — IRD's data-matching can identify patterns over time.
...
In serious cases — repeated evasion or large amounts — IRD can refer matters for criminal prosecution, which can result in fines or imprisonment.
...
1. Complete IRD's [voluntary disclosure form (IR281)](https://www.ird.govt.nz) or contact them directly
...
There's nothing wrong with accepting cash — it's still legal tender and a legitimate payment method. The obligation is simply to record and declare it properly. Here's how to do that:
...
**Use your job management app to track everything.** Apps like [Fastcrew](https://fastcrew.nz) make it easy to create job records, capture customer details, and generate invoices on the spot — even from a phone on site. Having a digital record of every job means your income matches your bank deposits when IRD comes looking.
...
If you're GST-registered (required once your turnover exceeds $60,000 per year), the stakes are even higher. Not declaring a cash job doesn't just hide income tax — it also means you haven't returned GST to the government.
...
It's worth bookmarking. IRD doesn't give much sympathy to the argument that you didn't know — the information is all publicly available.
...
- [ ] Are all your bank accounts — personal and business — reconciled?
...
If any of these are a "no" or "not sure," address them now — before IRD does.

---

**Download our free NZ tradie templates at tradietools.nz/templates/** — including invoice templates, expense trackers, and a simple cashbook to record every job cleanly.
