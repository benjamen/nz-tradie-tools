...
**Red flags in a cheap roof quote:**
- No mention of underlay, or an unusually cheap underlay specification.
- Unwillingness to confirm their LBP licence number.
- No consent process discussed for full reroofs.
- Very large upfront deposit required (more than 20–30%).
...
The [job cost calculator](/calculators/job-cost-calculator) is useful for building or checking your own roofing cost breakdown. And if you want to understand the LBP licensing framework that governs roofing and other restricted building work, the [LBP licence guide](/articles/how-to-get-lbp-licence-new-zealand) explains the categories, application process, and what the licence means in practice.
