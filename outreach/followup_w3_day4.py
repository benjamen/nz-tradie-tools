"""
Wave 3 Day 4 follow-up — nudge, make sure it didn't get buried.
Send ~Jun 28 (4 days after Jun 24 wave 3 sends).
Run: venv/bin/python3 outreach/followup_w3_day4.py [--dry-run]
"""
...
FOLLOWUP_LOG = Path(__file__).parent / "followup_w3_day4.log"

DRY_RUN = "--dry-run" in __import__("sys").argv

CAMPAIGN = "followup_w3_day4"
...
def main():
    ...
    print(f"{'DRY RUN — ' if DRY_RUN else ''}Sending Wave 3 Day 4 follow-ups to {len(rows)} contacts")
