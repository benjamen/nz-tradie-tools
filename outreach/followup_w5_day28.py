"""
Wave 5 Day 28 follow-up — final touch, social proof + soft close.
Send ~Jul 22 (28 days after Jun 30 wave 5 sends).
Run: venv/bin/python3 outreach/followup_w5_day28.py [--dry-run]
"""
...
FOLLOWUP_LOG = Path(__file__).parent / "followup_w5_day28.log"

DRY_RUN = "--dry-run" in __import__("sys").argv

CAMPAIGN = "followup_w5_day28"
...
def main():
    ...
    print(f"{'DRY RUN — ' if DRY_RUN else ''}Sending Wave 5 Day 28 follow-ups to {len(rows)} contacts")
