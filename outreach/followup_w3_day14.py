"""
Wave 3 Day 14 follow-up — data / social proof email.
Send ~Jul 8 (14 days after Jun 24 wave 3 sends).
Run: venv/bin/python3 outreach/followup_w3_day14.py [--dry-run]
"""
...
DAY4_LOG     = Path(__file__).parent / "followup_w3_day4.log"
...
def main():
    ...
    print(f"{'DRY RUN — ' if DRY_RUN else ''}Sending Wave 3 Day 14 follow-ups to {len(rows)} contacts")
