"""
Wave 2 Day 4 follow-up to the 77 initial outreach contacts.
...
FOLLOWUP_LOG  = Path(__file__).parent / "followup_w2_day4.log"
...
def main():
    ...
    print(f"{'DRY RUN — ' if DRY_RUN else ''}Sending Wave 2 Wave 2 Day 4 follow-ups to {len(rows)} contacts")
