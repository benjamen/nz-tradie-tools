"""
Wave 4 Day 28 follow-up — final touch, social proof + soft close.
Send ~Jul 26 (28 days after Jun 28 wave 4 starts).
Run: venv/bin/python3 outreach/followup_w4_day28.py [--dry-run]
"""
...
FOLLOWUP_LOG = Path(__file__).parent / "followup_w4_day28.log"

DRY_RUN = "--dry-run" in __import__("sys").argv

CAMPAIGN = "followup_w4_day28"
...
def main():
    ...
    print(f"{'DRY RUN — ' if DRY_RUN else ''}Sending Wave 4 Day 28 follow-ups to {len(rows)} contacts")
