"""
Wave 5 Day 14 follow-up — data / social proof email.
Send ~Jul 8 (14 days after Jun 30 wave 5 sends).
Run: venv/bin/python3 outreach/followup_w5_day14.py [--dry-run]
"""
...
CONTACTS_CSV = Path(__file__).parent / "contacts_wave5.csv"
FOLLOWUP_LOG = Path(__file__).parent / "followup_w5_day14.log"
DAY4_LOG     = Path(__file__).parent / "followup_w5_day4.log"
...
def main():
    ...
    print(f"{'DRY RUN — ' if DRY_RUN else ''}Sending Wave 5 Day 14 follow-ups to {len(rows)} contacts")
